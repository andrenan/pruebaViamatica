...
public class PdfService {
    ...
    @Autowired
    private SessionService placeService;

    @Autowired
    public PdfService(SpringTemplateEngine springTemplateEngine, SessionService placeService) {
    ...
    private Context getContextPlaceListPdf() {
        List<Sessions> placeList = this.placeService.list();
    ...
    private String loadAndFillTemplate(Context context) {
        return springTemplateEngine.process("reportePDF", context);
    }
